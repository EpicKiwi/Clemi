...
class Component extends HTMLElement {
    ...
    $defineProps() {
        ...
        Object.keys(props).forEach(propName => {
            ...
            let property = this.$getProperty(propName,prop) ;
    ...
    attributeChangedCallback(name,oldVal,newVal){
        ...
        let propObject = props[camelcase(name)]
        if(!propObject) return;
        this.$callPropCallback(propObject,oldVal,newVal)
    }

    $callPropCallback(propParser,oldVal,newVal){
        let callbackName = propParser.callback
